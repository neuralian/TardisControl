package com.zologic.TardisControl;
...
public class TardisControl extends Activity {
	private final static String TAG = TardisControl.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent gattServiceIntent = new Intent(TardisControl.this,
				RBLService.class);
